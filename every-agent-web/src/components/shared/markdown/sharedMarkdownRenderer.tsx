...
const variantStyles: Record<MarkdownVariant, {
  ...
  display: {
    paragraph: { ...baseParagraphStyle, fontSize: 'var(--text-sm)', lineHeight: 1.4, color: 'var(--text-secondary)' },
    blockquote: { ...baseBlockquoteStyle, margin: '4px 0', color: 'var(--text-secondary)', fontSize: 'var(--text-sm)', lineHeight: 1.4 },
    list: { margin: '2px 0', padding: 0, paddingLeft: '1.6em', listStyleType: 'disc' },
