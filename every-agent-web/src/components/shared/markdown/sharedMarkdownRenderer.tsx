...
const variantStyles: Record<MarkdownVariant, {
  ...
  preview: {
    ...
    th: { ...baseThStyle, color: 'var(--text-primary)', background: 'var(--bg-table)' },
  ...
  display: {
    ...
    table: baseTableStyle,
    th: { ...baseThStyle, lineHeight: 1.6, color: 'var(--text-primary)', background: 'var(--bg-table)', borderBottomColor: 'var(--border-light)' },
