 ...
 * <p>职责:
 * <ul>
 *   <li>固定 {@link #KIND} = {@code network.access};</li>
...
public final class NetworkToken {
    ...
    /** 网络 token 的固定 kind(提交解析 / 胶囊回显共用)。 */
    public static final String KIND = "network.access";
    ...
    /**
     * 判断文本是否包含「网络」标记(命中 {@code network.access} 且 enabled=true)。
    ...
    /**
     * 扫描文本命中 {@code network.access} token 时返回其 {@code enabled} 值;
