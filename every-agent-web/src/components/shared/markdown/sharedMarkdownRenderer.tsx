...
const variantStyles: Record<MarkdownVariant, {
  ...
  preview: {
    ...
    th: { ...baseThStyle, color: 'var(--text-primary)', background: 'color-mix(in srgb, var(--bg-table) 95%, var(--text-muted))' },
    td: { ...baseTdStyle, color: 'var(--text-primary)' },
    hr: { ...baseHrStyle, margin: '16px 0', borderTopColor: 'var(--border)' },
    code: { background: 'var(--bg-tertiary)', padding: '1px 5px', borderRadius: 4, color: 'var(--text-primary)', fontSize: 'var(--text-xs)', fontFamily: 'var(--font-mono)' },
  ...
  display: {
    ...
    table: baseTableStyle,
    th: { ...baseThStyle, lineHeight: 1.6, color: 'var(--text-primary)', background: 'color-mix(in srgb, var(--bg-table) 95%, var(--text-muted))', borderBottomColor: 'var(--border-light)' },
